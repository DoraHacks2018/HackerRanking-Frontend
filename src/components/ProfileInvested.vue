  ...
  <div>
    ...
    <div class="wrap">
      <div class="match">
        <div class="tab">
          <ul class="clearfix">
            <li><router-link to="/profile/project"><a>Projects</a></router-link></li>
            <li><router-link to="/profile/hackatahon"><a>Hackathons</a></router-link></li>
            <li><router-link to="/profile/github"><a>Github Repo</a></router-link></li>
            <li class="active"><a>Invested Projects</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="projects-list">
      <div class="item relative" v-for="v,i in list">
        ...
        <div class="invest" @click.stop="investIndex = i">
          <button class="btn btn-primary">Invest</button>
          <div class="confirm" v-show="i==investIndex" >
            <form action="" class="form">
              <div>Invest</div>
              <div>
                <input type="text">
                <button type="submit" class="btn btn-cancel">Confirm</button>
              </div>
              <div>Gift</div>
            </form>
          </div>
